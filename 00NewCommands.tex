...
\newcommand{\tempsek}[1]{\hat{A}_{#1}}
\newcommand{\tempesk}[1]{\hat{B}_{#1}}
\newcommand{\tempeek}[1]{\hat{C}_{#1}}
\newcommand{\groupsek}[1]{A_{#1}}
\newcommand{\groupesk}[1]{B_{#1}}
\newcommand{\groupeek}[1]{C_{#1}}
