...
\begin{document}
	...
	\titlerunning{Session-Tight GAKE from Weak Assumptions}
	...
	\institute{University of Kassel, Kassel, Germany \\
		\email{jiaxin.pan@uni-kassel.de}
	...
	\begin{abstract}
		...
		\keywords{Group authenticated key exchange \and Diffie-Hellman \and Tightness \and Random oracles}
	\end{abstract}
